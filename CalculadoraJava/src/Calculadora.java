...
public class Calculadora {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("multiplica ámbos números e imprime el resultado, entrega el cociente de una división (el primer número dividido por el segundo), ");
        System.out.println("y así también entrega el resto del primer número dividido por el segundo");
        ...
        System.out.println("\nEl cociente, del resultado de la división del primer número ingresado por el segundo en ingresar es: " + primerNumero + " / " + segundoNumero + " = " + divisionDeAmbosNumerosIngresados);
        System.out.println("Y el resto de esta división es: " + (primerNumero % segundoNumero));
